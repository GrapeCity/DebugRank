package com.grapecity.debugrank.ui.misc.like;
...
public class LikeButtonView extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        isChecked = !isChecked;
        //ivStar.setImageResource(isChecked ? R.drawable.ic_grade_gold : R.drawable.ic_grade_gold);
        ivStar.setImageResource(R.drawable.ic_grade_gold);
